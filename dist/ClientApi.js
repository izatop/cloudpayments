...
class ClientApi extends ClientAbstract_1.ClientRequestAbstract {
    ...
    createOrder(data) {
        return __awaiter(this, void 0, void 0, function* () {
            assert_1.ok(data.Description, 'Description is required');
            assert_1.ok(typeof data.Amount == 'number' && data.Amount > 0, 'Payment.Amount should be valid');
            assert_1.ok(constants_1.validateCurrency(data.Currency), 'Payment.Currency should be valid');
    ...
    createSubscription(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.call('/subscriptions/create', data);
        });
    }
    updateSubscription(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.call('/subscriptions/update', data);
        });
    }
    cancelSubscription(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.call('/subscriptions/cancel', data);
        });
    }
    getSubscription(data) {
        return __awaiter(this, void 0, void 0, function* () {
            assert_1.ok(data.Id, 'Id is required');
            return this.call('/subscriptions/get', data);
        });
    }
    getSubscriptionsList(data) {
        return __awaiter(this, void 0, void 0, function* () {
            assert_1.ok(data.accountId, 'accountId is required');
            return this.call('/subscriptions/find', data);
        });
    }
}
